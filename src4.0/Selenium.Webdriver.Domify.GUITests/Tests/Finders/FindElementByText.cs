...
namespace Selenium.Webdriver.Domify.GUITests.Tests.Finders
{
    ...
    public class FindButtonByText : BrowserScenario
    {
        private const string ListId = "textbox1";

        protected override void Given()
        {
            Document.Navigation.GoTo<GenericElementPage>(new { id = ListId, tag = "button", text = "Hello world", type = "" });
        ...
        {
            var div = Document.Navigation.GetCurrentPage<GenericElementPage>().Document.Button(Find.ByText("Hello world"));
        ...
        {
            var div = Document.Navigation.GetCurrentPage<GenericElementPage>().Document.Div(Find.ByText("Hello"));
        ...
        public void ShouldBeAbleToFindElementByTextWithinElement()
        {
            ...
            var div = root.Button(Find.ByText("Hello world"));
            Assert.That(div, Is.Not.Null);
        }
    }
