...
namespace Selenium.Webdriver.Domify.GUITests
{
    ...
    public class KnockoutTextFieldTests : BrowserScenario
    {
        ...
        [Then]
        public void TheKnockoutLabelShouldHaveTheSameValue()
        {
            Assert.That(Document.Navigation.GetCurrentPage<HomeIndex>().KnockoutSpan.Text, Is.EqualTo(TextToTypeIntoTextBox));
        }
        ...
        {
            Document.Navigation.GetCurrentPage<HomeIndex>().KnockoutTextBox.Value = (TextToTypeIntoTextBox);
        }
    }
}