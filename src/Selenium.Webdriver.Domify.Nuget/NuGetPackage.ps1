...
$Assemblyversion =  $AssemblyName.version.Major.ToString() +"." +$AssemblyName.version.Minor.ToString() +"."+$AssemblyName.version.Build.ToString()+"."+ $AssemblyName.version.Revision.ToString()
